...
@Component({
  selector: 'app-select-payment-code',
  templateUrl: './select-payment-code.component.html',
  styleUrls: ['./select-payment-code.component.scss']
})
export class SelectPaymentCodeComponent implements OnInit {
